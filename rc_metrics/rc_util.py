...
## adapted from server.py - original here: https://github.com/Coleridge-Initiative/RCServer/blob/master/richcontext/server/server.py
...
class RCNetwork:
    ...
    def parse_corpus (self, path):
        ...
        Note: connections between entities means the
        order of adding entities matters; for example,
        all datasets need to be added before publications
        are added
        """
